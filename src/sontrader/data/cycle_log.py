...
- **봇이 살아 있었나** — 행이 있으면 살아 있었다. 장중 60초 주기이므로
  09:00~15:30에 약 390행이 있어야 정상이고, 구멍이 곧 다운타임이다.
...
장중 하루 약 390행, 연 10만 행. 무시할 수준이라 사이클마다 무조건 남긴다 —
"변화가 있을 때만"으로 조건을 걸면 정작 필요한 "아무 일도 없었다"는 사실이
사라진다.
"""
